  ...
  module UsecaseDeliverer
    ...
    class BgpProcDataBuilder < Layer3DataBuilder
      ...
      def add_bgp_proc_ibgp_links(peer_item_bgp_proc_pair)
        ...
        # node tp
        _, bgp_proc_tp1 = add_bgp_proc_tp(bgp_proc_node1, "peer_#{tp2_ip_str}", tp1_ip_str, tp2_ip_str,
                                          layer3_edge[:node1])
        _, bgp_proc_tp2 = add_bgp_proc_tp(bgp_proc_node2, "peer_#{tp1_ip_str}", tp2_ip_str, tp1_ip_str,
                                          layer3_edge[:node2])
